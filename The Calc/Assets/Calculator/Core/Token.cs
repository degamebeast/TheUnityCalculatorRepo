...
{
    public enum TokenTypeValue { Null, Invalid, Ignore, Any, Identifier, Constant, Integer, Variable, Expression, Function, Parameters, Argument, Dot, Open_Paren, Close_Paren, Seperator, End_Statement, Operation, Exponent, Multiplication, Division, Modulo, Addition, Subtraction, Assignment, Left_Shift, Right_Shift }
